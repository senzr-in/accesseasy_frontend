        ...
        <div class="space-y-4">
          ...
          <div class="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              >
                ...
                <option value="Lobby West">
                  Lobby West
                </option>
                <option value="Server Room">
                  Server Room
                </option>
                <option value="Parking Gate">
                  Parking Gate
                </option>
              </select>
            </div>
          ...
          >
            <div class="p-3 bg-indigo-50 dark:bg-indigo-500/10 rounded-xl border border-indigo-100 dark:border-indigo-500/20 flex items-center justify-between">
              <div>
                <h4 class="text-xs font-bold text-indigo-900 dark:text-indigo-300">
                  ONVIF Network Subnet Scan
                </h4>
            ...
            <div>
              ...
              >
                <option value="default">
                  Default Kiosk Webcam (Integrated HD Camera)
                </option>
                <option value="usb-2">
                  USB Video Capture Dongle 02
                </option>
              </select>
            </div>
          </div>
          ...
          <div>
            ...
            >
              <option value="door_1">
                Door 1 - Main Entrance (Reader #1)
              </option>
              <option value="door_2">
                Door 2 - Lobby West (Reader #2)
              </option>
              <option value="door_3">
                Door 3 - Server Room Access
              </option>
              <option value="door_4">
                Door 4 - Executive Suite
              </option>
            </select>
          </div>
