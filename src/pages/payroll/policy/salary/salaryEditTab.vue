  ...
  <div class="employee-form-container">
    ...
    <div class="form-header">
      ...
      <div class="header-center">
        <h2 class="form-title">
          {{ isEditing ? "Create PayrollPolicies" : "Add Employee" }}
        </h2>
      </div>
...
import EditTab from "@/pages/payroll/policy/salary/salaryTemplateEdit.vue";
...
const cancelForm = () => {
  if (props.isDialog) {
    ...
    router.push("/payroll/policy/payroll-policy");
  }
};
...
onMounted(async () => {
  try {
    const response = await fetch(
      `${import.meta.env.VITE_API_URL}/items/personalModule/${id.value}`,
      {
