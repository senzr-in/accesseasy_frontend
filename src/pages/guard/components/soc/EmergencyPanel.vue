<template>
  ...
  >
    <!-- SOS / Emergency Block -->
    <div class="p-5 border-b border-slate-200 dark:border-slate-800/50 dark:border-white/5 relative z-10 flex flex-col items-center justify-center bg-rose-50/50 dark:bg-rose-950/20 text-center">
      <div 
      ...
      >
        <Siren
          class="w-8 h-8"
          :class="hasEmergency ? 'text-white' : 'text-slate-400 dark:text-slate-600 dark:text-slate-300'"
        />
      </div>
      
      <h3
        class="text-sm font-black uppercase tracking-widest"
        :class="hasEmergency ? 'text-rose-600 dark:text-rose-400' : 'text-slate-500 dark:text-slate-400'"
      >
      ...
      <button 
        ...
        :class="hasEmergency 
          ...
          : 'bg-white dark:bg-slate-800 text-slate-400 border-slate-200 dark:border-white/10 hover:bg-slate-50 dark:hover:bg-slate-800/50 dark:hover:bg-slate-700'"
      >
