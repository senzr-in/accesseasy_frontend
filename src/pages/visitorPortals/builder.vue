    ...
    <div class="h-16 flex items-center justify-between px-6 bg-white dark:bg-zinc-900 border-b border-slate-200 dark:border-zinc-800 shrink-0 shadow-sm">
      ...
      <div class="flex items-center gap-3">
        <button
          ...
          @click="router.push('/dashboard/visitors?tab=portals')"
        >
        ...
        <div class="bg-white dark:bg-zinc-900 rounded-2xl border border-slate-200 dark:border-zinc-800 shadow-sm overflow-hidden">
          ...
          <div class="p-8 border-b border-slate-100 dark:border-zinc-800 space-y-6">
            <div class="flex items-center justify-between">
              ...
              <label class="relative inline-flex items-center cursor-pointer">
                ...
                <span class="ms-3 text-[10px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest">Portal Enabled</span>
              </label>
            </div>
            ...
            <div class="flex flex-col md:flex-row gap-8 items-start">
              ...
              <div class="shrink-0">
                <div
                  class="relative w-32 h-32 rounded-2xl border-2 border-dashed border-slate-200 dark:border-zinc-700 flex items-center justify-center cursor-pointer hover:border-blue-500 overflow-hidden transition-all group bg-slate-50 dark:bg-zinc-950"
                  @click="$refs.logoInput.click()"
                >
                  <button
                    v-if="pageConfig.logoPreview || pageConfig.logoId"
                    class="absolute top-1 right-1 bg-red-500 hover:bg-red-600 text-white rounded-full p-1 shadow-sm opacity-0 group-hover:opacity-100 transition-opacity z-10"
          ...
          >
            ...
            <div class="space-y-4">
              ...
              >
                <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 cursor-pointer" @click="expandedField = expandedField === key ? null : key">
                  <!-- Field Header & Icon -->
                  <div class="flex items-center gap-4">
                  ...
                  <!-- Action Toggles -->
                  <div class="flex items-center gap-6 justify-between md:justify-end" @click.stop>
                    ...
                    <ChevronDown class="w-4 h-4 text-slate-400 transition-transform hidden md:block" :class="{ 'rotate-180': expandedField === key }" />
                  </div>
                </div>

                <!-- Editable Labels & Placeholders -->
                <div
                  v-if="field.visible && expandedField === key"
                ...
                >
                  <div class="space-y-1">
                    ...
                    <input
                      v-model="field.label"
                      type="text" 
                      :placeholder="defaultFieldsConfig[key].label"
                  ...
                  <div class="space-y-1">
                    ...
                    <input
                      ...
                      type="text" 
                      :placeholder="defaultFieldsConfig[key].placeholder"
                      class="w-full h-9 px-3 border border-slate-200 dark:border-zinc-800 rounded-xl bg-slate-50 dark:bg-zinc-900 text-xs font-semibold text-slate-700 dark:text-zinc-200 outline-none focus:border-blue-500 transition-colors"
                    >
                  </div>
                </div>
    ...
    >
      ...
      <div class="relative bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800 rounded-2xl p-8 max-w-sm w-full text-center shadow-2xl animate-in zoom-in-95 duration-200">
        ...
        <button
          ...
          @click="saveSuccessDialog = false; router.push('/dashboard/visitors?tab=portals')"
        >
          Back to My Portals
        </button>
      </div>
...
import {
  ...
  SlidersHorizontal, Camera, FileUp, ShieldOff, ArrowLeft, ChevronDown
...
const pageConfig = ref({
  ...
  fieldsConfig: {
    name: { visible: true, required: true, label: '', placeholder: '' },
    mobile: { visible: true, required: true, label: '', placeholder: '' },
    email: { visible: false, required: false, label: '', placeholder: '' },
    govtId: { visible: true, required: true, label: '', placeholder: '' },
    reasonForVisit: { visible: true, required: true, label: '', placeholder: '' },
    personToMeet: { visible: true, required: false, label: '', placeholder: '' },
    company: { visible: true, required: false, label: '', placeholder: '' },
    photo: { visible: false, required: false, label: '', placeholder: '' },
    proofDocument: { visible: false, required: false, label: '', placeholder: '' }
  }
});
...
const removeLogo = () => {
  ...
  pageConfig.value.logoPreview = null;
  pageConfig.value.logoId = null;
};
