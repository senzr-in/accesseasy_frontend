<template>
  <div class="min-h-screen flex items-center justify-center bg-slate-950 font-sans">
    <div class="w-full max-w-sm p-8 rounded-2xl bg-slate-900 border border-slate-800 shadow-2xl text-center">
      ...
      <h1 class="text-xl font-black text-white mb-1 tracking-tight">Dev Quick Login</h1>
      <p class="text-xs text-slate-400 mb-7 font-medium">Select a role to bypass login for UI testing</p>
      ...
      <div class="space-y-3">
        ...
        >
          <div class="h-9 w-9 shrink-0 rounded-xl bg-violet-600/20 flex items-center justify-center">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-violet-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"/></svg>
          </div>
          <div class="text-left">
            <div class="text-sm font-bold text-white">Super Admin</div>
            <div class="text-[10px] text-violet-400 font-semibold uppercase tracking-widest">esslAdmin · All Tenants</div>
          </div>
        </button>
        ...
        >
          <div class="h-9 w-9 shrink-0 rounded-xl bg-blue-600/20 flex items-center justify-center">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-blue-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
          </div>
          <div class="text-left">
            <div class="text-sm font-bold text-white">Tenant Admin</div>
            <div class="text-[10px] text-blue-400 font-semibold uppercase tracking-widest">Admin · Single Tenant</div>
          </div>
        </button>
        ...
        >
          <div class="h-9 w-9 shrink-0 rounded-xl bg-emerald-600/20 flex items-center justify-center">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-emerald-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
          </div>
          <div class="text-left">
            <div class="text-sm font-bold text-white">Employee</div>
            <div class="text-[10px] text-emerald-400 font-semibold uppercase tracking-widest">Employee · Self-service</div>
          </div>
        </button>
      </div>

      <p class="mt-6 text-[10px] text-slate-600 font-semibold uppercase tracking-widest">⚠ Development only · Remove before production</p>
    </div>
  </div>
</template>
